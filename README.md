...
> [!NOTE]
> Additionally, we support PyVista plots (thanks to [edsaac/stpyvista](https://github.com/edsaac/stpyvista))! Just annotate your function to return a `pyvista.Plotter` instance, and an interactive plot will be inserted. 
