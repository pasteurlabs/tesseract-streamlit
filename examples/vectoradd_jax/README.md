...
We'll use the `vectoradd_jax` example from `tesseract-core`. Clone it with:

```shell
git clone --depth 1 --branch v1.13.0 https://github.com/pasteurlabs/tesseract-core.git ~/Downloads/tesseract-core
```
